...
public class kiruba {
    ...
    static String Admin_User = "kiruba";
    ...
    kiruba(String Name, String Pin, int Balance) {
        this.User_Name = Name;
        this.User_Pin = Pin;
    ...
    public static void main(String[] args) {
        ...
        if (State == 1) {
            atm = new kiruba[3];
            atm[0] = new kiruba("Bala", "1234", 5000);
            atm[0].User_Statement = new ArrayList<>();
            atm[1] = new kiruba("Aishu", "1234", 5000);
            atm[1].User_Statement = new ArrayList<>();
            atm[2] = new kiruba("Harshu", "1234", 5000);
